                    ...
                    <div className="d-flex flex-wrap flex-sm-nowrap">
                        <div className="me-7 mb-4">
                            <div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="https://keenthemes.com/metronic8/demo7/assets/media/avatars/300-1.jpg" alt="image"/>
                                <div
                            ...
                            <div className="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                <div className="d-flex flex-column">
                                    ...
                                    <div className="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                        <a href="#"
                                           className="d-flex align-items-center text-gray-500 text-hover-fsh-primary me-5 mb-2">
                                            <i className="ki-duotone ki-profile-circle fs-4 me-1"><span
                                                className="path1"></span><span className="path2"></span><span
                                                className="path3"></span></i> {user.role === 'admin' ? 'Yönetici' : 'Satış Temsilcisi'}
                                        </a>
                                        <a href="#"
                                           className="d-flex align-items-center text-gray-500 text-hover-fsh-primary me-5 mb-2">
                                            <i className="ki-duotone ki-geolocation fs-4 me-1"><span
                                                className="path1"></span><span className="path2"></span></i> Sare Gayrimenkul Ana Ofis
                                        </a>
                                        <a href="#"
                                           className="d-flex align-items-center text-gray-500 text-hover-fsh-primary mb-2">
                                            <i className="ki-duotone ki-sms fs-4 me-1"><span
                                                className="path1"></span><span className="path2"></span></i> {user.email}
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div className="d-flex flex-wrap">
                                        <div
                                            ...
                                            <div className="d-flex align-items-center">
                                                <i className="ki-duotone ki-arrow-up fs-3 text-success me-2"><span
                                        ...
                                        <div
                                            className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            <div className="d-flex align-items-center">
                                                <i className="ki-duotone ki-arrow-down fs-3 text-danger me-2"><span
                                                    className="path1"></span><span className="path2"></span></i>
                                                <div className="fs-2 fw-bold counted" data-kt-countup="true"
